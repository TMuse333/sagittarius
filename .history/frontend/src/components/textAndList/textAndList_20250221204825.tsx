...
parentInView
    ...
    return (
        ...
        <button
          className="w-full flex justify-between items-center text-left text-black p-4 font-semibold bg-[#4D8890] rounded-t-lg focus:outline-none"
        ...
        <div
          className={`transition-all duration-500 bg-gradient-to-b from-[#4D8890] to-[#A8C8D0] ease-in-out bg- overflow-hidden ${
...
const TextAndList:React.FC<Props> = ({
    ...
    //   }
      ...
      return (
        <section className="w-full  bg-gradient-to-b from-[#4D8890] to-[#A8C8D0]">
