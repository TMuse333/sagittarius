...
const VerticalImageTextBox:React.FC<Props> = ({
  ...
  return (
    ...
    z-[1] border-t border-[#4D8890] border-t-8
    border-b-8
    py-8
   "
   style={{
...
{/* <div className="absolute w-full h-[15px]
bg-red-200 top-0 left-0 z-[2]"
/> */}
...
{hasScroll ? (
  <motion.button
    ...
    onClick={() => {
      const targetElement = document.getElementById(buttonDestination);
      if (targetElement) {
