...
<button 
  className="rounded-full border border-neutral-950 p-3 text-sm font-medium transition-colors hover:bg-neutral-950 hover:text-neutral-100 bg-[#338d96] mr-4"
  onClick={hasScroll ? () => scrollToDestination(destination) : () => window.location.href = destination}
>
