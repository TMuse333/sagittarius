...
const CarouselHero: React.FC<CarouselHeroProps> = ({
 ...
 images,
  ...
  return (
   ...
   "
    >
        <div className="absolute top-[10%] z-[100] w-full bg-gradient-to-t from-[#4D8890] to-[#A8C8D0] h-[30px]"></div>
        <div className="absolute bottom-[10%] z-[100] w-full bg-gradient-to-t from-[#4D8890] to-[#A8C8D0] h-[100px]"></div>
      {!regularText ? (
