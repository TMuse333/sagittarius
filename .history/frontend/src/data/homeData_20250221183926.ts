...
export const carouselHeroData = {
    mainHeader: "Fences and decks",
    titleText: "Saggitarius Construction",
    descriptionText:
    ...
    images: [
        ...
        {
            src: '/indoor-1.webp',
            alt: 'Indoor renovation by Sagittarius Construction',
            description: 'A modern indoor renovation featuring fresh paint and high-quality materials.'
        },
        {
            src: '/kitchen-2.webp',
            alt: 'Modern kitchen by Sagittarius Construction',
            description: 'A stylish and functional kitchen with updated cabinetry and appliances.'
        },
        {
            src: '/tyvek.webp',
            alt: 'House under construction with Tyvek wrap',
            description: 'A home exterior wrapped in Tyvek for weatherproofing during construction.'
        },
        {
            src: '/wall-after.webp',
            alt: 'Finished interior wall by Sagittarius Construction',
            description: 'A freshly renovated wall with a smooth and clean finish.'
        }
    ]
...
export const imageTextBoxData2 = {
    ...
    description: 'From classic wooden decks to modern composite designs, we create outdoor spaces tailored to your needs. Our expert builders ensure a seamless process from design to completion.',
...
export const testimonialsData = {
  ...
  description: "See what our satisfied customers have to say about our deck and fence projects.",
  bgImage: false,
  images: [
      {
          src: "/client.png",
          alt: "Mark's Deck Installation",
          title: "Built My Dream Deck",
          description: "“Sagittarius Construction transformed my backyard with a beautiful deck. Their craftsmanship is top-notch!” – Mark",
          link: "",
          date: "2024-01-15"
      },
      {
          src: "/client.png",
          alt: "Lisa's Fence Upgrade",
          title: "Strong and Stylish Fence",
          description: "“They built a solid, stylish fence that gives my family privacy and security. Highly recommend!” – Lisa",
          link: "",
          date: "2023-11-28"
      }
  ]
...
export const closingStatement = {
  title: "Upgrade Your Outdoor Space Today",
  description: `Looking to enhance your backyard with a custom deck or fence? Sagittarius Construction is here to bring your vision to life. With years of experience and a dedication to quality, we create stunning outdoor spaces tailored to your needs.
  
  From small backyard decks to full outdoor renovations, our team ensures durability and expert craftsmanship in every build.
  
  Contact us today for a free consultation and let's get started on your next project!`,
