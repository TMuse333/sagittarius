...
export const deckTextBox: ContentProps = {
  ...
  description: 'Our team specializes in designing and building high-quality, durable decks that enhance outdoor spaces. We use premium materials and expert craftsmanship to create decks that are both stylish and long-lasting, ensuring you get the perfect space for relaxing and entertaining.',
  title: 'Our Decks',
};
...
export const fenceTextBox: ContentProps = {
  ...
  description: 'We build strong, aesthetically pleasing fences that provide security, privacy, and curb appeal. Whether you need a classic wooden fence or a custom design, we ensure top-tier craftsmanship and high-quality materials to make your property stand out while staying protected.',
  title: 'Our Fences',
};
