...
export const renovationIntro = {
  ...
  description: 
    "At Sagittarius Construction, we bring over 5 years of experience in delivering top-quality renovations with minimal disruption to your daily life. Whether it's a modern kitchen, a refreshed bathroom, or a full home makeover, our expert craftsmanship ensures stunning results—on time and within budget. We work efficiently, so you can enjoy your newly upgraded space sooner, without the hassle.",
